        ...
        <div>
            <footer className="footer p-10 bg-gradient-to-r from-secondary to-primary text-white mt-28">
                <div>
                    ...
                    <Link to='/' className="link link-hover">Get Equipment</Link>
                    <Link to='/' className="link link-hover">Help Center</Link>
                    <Link to='/' className="link link-hover">Online Booking</Link>
                </div>
                <div>
                    <span className="footer-title text-2xl">Company</span>
                    <Link to='/' className="link link-hover">About us</Link>
                    <Link to='/' className="link link-hover">Profile</Link>
                    <Link to='/' className="link link-hover">Vision & Mission</Link>
                    <Link to='/' className="link link-hover">Infrastructure</Link>
                ...
                <div>
                    ...
                    <Link to='/' className="link link-hover">Customer Right and Advocacy</Link>
                </div>
            </footer>
